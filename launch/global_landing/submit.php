...
// ── Config ────────────────────────────────────────────────────────────────────
define('ALLOWED_ORIGINS', ['https://aggilo.in', 'https://www.aggilo.in', 'https://aggilo.com', 'https://www.aggilo.com']);
define('FROM_EMAIL',      'clio@aggilo.com');
define('FROM_NAME',       'Clio · Aggilo');
define('TO_FIND',         'mypeople@aggilo.com');
define('TO_MYC',          'mycrowd@aggilo.com');
...
if ($mailSent) {
    ...
    if ($saved) {
        ...
        jsonOut(500, false, 'Submission could not be saved. Please email hello@aggilo.com directly.');
    }
}
