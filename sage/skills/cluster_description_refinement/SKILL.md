# Sage Skill — `cluster_description_refinement`

> **How Sage Refines Cluster Descriptions and Tags as the Cluster Matures**
> *Addendum to [Sage SOUL v1.1](file:///d:/Aggilo_Social/sage/SOUL.md) and [Clio ↔ Sage Handoff v1.1](file:///d:/Aggilo_Social/docs/CLIO_SAGE_HANDOFF.md)*
...
| Property | Value |
|----------|-------|
| **Skill ID** | `cluster_description_refinement` |
| **Owner** | Sage |
| **Loaded when** | Sage forms a description refinement hypothesis based on cluster behaviour |
| **Depends on** | Cluster conversation history, Atlas content performance, Clio review queue |
| **Output** | `SageDescriptionProposal` to Clio review queue → live description update |
...
*Cluster Description Refinement Spec · v1.0 · Addendum to [Sage SOUL v1.1](file:///d:/Aggilo_Social/sage/SOUL.md) and [Handoff v1.1](file:///d:/Aggilo_Social/docs/CLIO_SAGE_HANDOFF.md)*
