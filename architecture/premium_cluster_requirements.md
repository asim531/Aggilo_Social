...
6. **Privacy boundaries.** Clio's "Just Clio · forgets" tab content is never persisted server-side. The Admin cannot configure Clio to log private messages, share them with Sage, or pull them into cluster context. Even an Admin who is also the user of the private tab does not break this rule.
