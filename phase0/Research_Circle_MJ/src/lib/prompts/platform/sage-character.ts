/**
 * Sage's generic character + decision framework — Research Circle MJ copy.
 *
 ...
 *     Research Circle MJ). Step 1 (citation check) and Step 3 (reference
 *     surface) are softened to general "verifiable claim" handling.
 *   - The fiqh-redirect step (Step 2) is removed — Research Circle MJ has
 ...
 *
 * Cluster-specific behaviour (the four named interventions for Research
 * Circle MJ) layers on top via `clusters/research_circle_mj/sage.ts`.
 */
