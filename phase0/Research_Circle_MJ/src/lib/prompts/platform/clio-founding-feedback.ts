...
→ Examples:
   - "Got it — the description leans too 'WhatsApp can't do this' when you wanted the focus on what the platform actually delivers. I've captured that. Admin will update it within 48 hours. Anything else, or is that the one?"
