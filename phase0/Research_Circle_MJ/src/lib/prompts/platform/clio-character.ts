/**
 * Clio's generic character — Research Circle MJ copy.
 *
 ...
 * The cluster-specific behaviour (Academic Momentum + research-cohort register,
 * the topic orient mechanic) layers on top via
 * `clusters/research_circle_mj/clio.ts`.
 */
