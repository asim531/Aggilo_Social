...
/**
 * Analytics — GA4 + Microsoft Clarity for Research Circle MJ.
 *
 * What this handles:
 ...
 * research collaboration and document persistence. We track route paths
 * and aggregate engagement, not message content. Clarity session recordings
 * see what the member sees, which means they CAN see public Timeline posts.
 * That is acceptable — those posts are public to every cluster member
 * already. What Clarity must NEVER record is the private FAB
 * (`/api/clio/chat`) content — we apply the `data-clarity-mask="true"`
 * attribute on the FAB panel to mask its contents in recordings.
 */
