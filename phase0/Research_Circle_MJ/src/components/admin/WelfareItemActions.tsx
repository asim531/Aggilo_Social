  ...
  return (
    <div className="flex flex-col items-end gap-1">
      <button
        ...
        disabled={busy}
        className="px-3 py-1 text-xs rounded bg-husl-clio text-white font-medium hover:bg-amber-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
      >
