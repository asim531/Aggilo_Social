...
export default async function FeaturesPage() {
  ...
  return (
    <div className="min-h-screen bg-husl-surface">
      <header className="bg-husl-card border-b border-stone-200 sticky top-0 z-40">
        <div className="max-w-3xl mx-auto px-4 h-16 flex items-center justify-between">
          <div>
            <p className="text-xs uppercase tracking-[0.18em] text-husl-muted">
              Aggilo · Research Circle MJ
            </p>
            <h1 className="text-base font-semibold text-husl-ink">
              Room Workshop
            </h1>
          </div>
          <Link
            href="/cluster"
            className="text-xs text-husl-muted hover:text-husl-ink transition-colors px-2 py-1 rounded hover:bg-stone-100"
          >
            ← Cluster
          </Link>
        </div>
      ...
      <main className="max-w-3xl mx-auto px-4 py-6">
        <p className="text-sm text-husl-muted mb-6">
