...
-- ┌──────────────────────────────────────────────────────────────────┐
-- │  STEP 3: Research Circle MJ founding-member designation           │
-- │                                                                  │
-- │  Tas (tasneem.bano@gmail.com) is the founding member of Research │
-- │  Circle MJ. She submitted the waitlist request that produced    │
...
-- │  phase0/Research_Circle_MJ/src/app/auth/callback/route.ts FOUNDING_EMAIL check). │
-- └──────────────────────────────────────────────────────────────────┘
