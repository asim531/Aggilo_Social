/*
 * Migration 08: Document Intelligence Suite
 *
 * Adds pgvector, citation links, versions, embeddings, annotations,
 * reading status, and paper status lifecycle.
 */
...
-- ┌──────────────────────────────────────────────────────────────────┐
-- │  Metadata columns on post_attachments                             │
-- └──────────────────────────────────────────────────────────────────┘
...
-- ┌──────────────────────────────────────────────────────────────────┐
-- │  paper_citations — bidirectional links between papers           │
-- └──────────────────────────────────────────────────────────────────┘
...
-- ┌──────────────────────────────────────────────────────────────────┐
-- │  paper_versions — document revision history                     │
-- └──────────────────────────────────────────────────────────────────┘
...
-- ┌──────────────────────────────────────────────────────────────────┐
-- │  paper_embeddings — pgvector for semantic search                  │
-- └──────────────────────────────────────────────────────────────────┘
...
-- ┌──────────────────────────────────────────────────────────────────┐
-- │  paper_annotations — public/private notes per paper              │
-- └──────────────────────────────────────────────────────────────────┘
...
create table if not exists public.paper_annotations (
  ...
  pass_type         text, -- nullable: null = general annotation, else links to decomposition pass
  created_at        timestamptz default now() not null
);
...
-- ┌──────────────────────────────────────────────────────────────────┐
-- │  paper_reading_status — per-user tracking                       │
-- └──────────────────────────────────────────────────────────────────┘
...
-- ┌──────────────────────────────────────────────────────────────────┐
-- │  paper_status_log — status transition history                   │
-- └──────────────────────────────────────────────────────────────────┘
...
-- ── Search helper (text-based; searches title, summary, keywords, authors, text, and decompositions) ──
...
-- ── Semantic vector search using pgvector (requires query embedding from caller) ──
