/**
 * Welfare signal detection — Long Conversation.
 *
 ...
 *
 * The patterns are tuned for Long Conversation's intimacy cohort:
 * loneliness, the failure of apps, and the specific vulnerability of
 * wanting genuine connection are the cluster's SUBJECT MATTER, not
 * welfare signals. Welfare fires only when the language crosses into
 * inability, hopelessness with finality, isolation as a permanent
 * condition, coercion, or self-harm indicators.
 *
