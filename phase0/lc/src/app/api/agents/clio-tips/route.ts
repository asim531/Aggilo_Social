...
Their recent activity indicates they haven't posted in 48 hours. Generate a short, direct nudge (max 2 sentences) encouraging them to share what's on their mind.
Be warm but not sentimental. Do not explain why sharing matters, just invite the next step.`;
