...
/**
 * Admin layout — Long Conversation.
 *
      ...
      <header className="bg-lc-card border-b border-stone-200">
        <div className="max-w-5xl mx-auto px-4 h-14 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm font-semibold text-lc-ink">Admin</span>
          </div>
          <nav className="flex items-center gap-4 text-sm">
            <Link
              href="/admin/welfare"
              className="text-lc-ink hover:text-lc-clio transition-colors"
            >
              Welfare
            </Link>
            <Link
              href="/cluster"
              className="text-lc-muted hover:text-lc-ink transition-colors"
            >
              ← Cluster
            </Link>
          </nav>
