# Aggilo MVP — Continuation Guide

> **Purpose:** If you're a new Claude session picking up this work, read this
> file FIRST. It tells you what exists, what works, what doesn't, and what to
> build next.
