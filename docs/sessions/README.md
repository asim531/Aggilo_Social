...
|---|---|---|---|
| **A** | [`SESSION_A_CONFIGURABILITY.md`](SESSION_A_CONFIGURABILITY.md) | **Closing & shipping.** Fix in-flight bugs, ship premium configurability schema, decide cluster-identity questions. | Closed 2026-05-22 |
