# AI Assistant Setup Reference

> **Purpose:** Configuration reference for AI assistants working on the Aggilo codebase.
>
> **Scope:** Development tooling and assistant context. For product architecture, read `ARCHITECTURE.md`.
